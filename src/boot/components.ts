...
import ConsultaTabContent from 'src/components/index/ConsultaTabContent.vue'
...
declare module '@vue/runtime-core' {
  export interface GlobalComponents {
    ...
    ConsultaTabContent: typeof ConsultaTabContent,
...
export default defineBoot(({ app }) => {
  ...
  app.component('ConsultaTabContent', ConsultaTabContent)
